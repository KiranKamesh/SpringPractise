package com.mouritech.sellermanagement.config;
...
@ComponentScan({
	"com.mouritech.sellermanagement"
})
@EnableJpaRepositories(basePackages = "com.mouritech.sellermanagement.repository")
public class AppContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan(new String[] {
				"com.mouritech.sellermanagement.entity"
		});
